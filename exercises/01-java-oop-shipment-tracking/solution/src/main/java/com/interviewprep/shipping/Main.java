...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, TrackingEvent> latestByShipment = service.latestEventByShipmentId(List.copyOf(shipment.getTrackingEvents()));
        System.out.println("Latest event count: " + latestByShipment.size());
    }
}
